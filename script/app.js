...
[
	...
	new Question("Давайте кратко по командам продолжим предложение: Какие из пройденных тем Вам были хорошо понятны, а что именно было трудно при изучении тем", 
	[
		new Answer("поехали дальше", 1)
	]),
	new Question("Объясните кратко, что это за такие термины Конституция, ГКЧП ПУТЧ, Декларация,  буквально своими словами ", 
	[
		new Answer("далее", 1)
	]),
	new Question("Попробуйте объяснить, с какими проблемы столкнулся Узбекистан на своем пути к независимости с 1991 года (аргументы) ", 
	[
		new Answer("далее", 1)
	]),
	new Question("Как Вы пониманете слова Гражданское общество и этапы формирования гражданского общества в Узбекистане, приведите главные факты", 
	[
		new Answer("далее", 1),
	]),
	new Question("Как Вы понимаете термин Узбекская модель развития Узбекистана и её главные цели", 
	[
		new Answer("далее", 1),
	]),
	new Question("Объясните, для какой цели необходимыы политичекие партии и какие партии у нас существуют", 
	[
		new Answer("далее", 1),
	]),
	new Question("Как Вы понимате термин махалля и  местные органы власти, какую задачу они должны выполнять", 
	[
		new Answer("далее", 1),
	]),
	new Question("Как Вы понимаете слова Уникальный, собственный  путь развития Узбекистана, что это значит ", 
	[
		new Answer("далее", 1),
	]),
	new Question("Поделитесь своим мнением, что Вас было понятно или непонятно сегодня на уроке, а какое у Вас настроение", 
	[
		new Answer("далее", 1),
	]),
];
